...
// //
// //     await db.execute('''
// //       CREATE TABLE running_serial_number (
// //         org_id TEXT PRIMARY KEY,
// //         project_last_serial_number INTEGER DEFAULT 0,
// //         emp_last_serial_number INTEGER DEFAULT 0,
// //         att_last_serial_number INTEGER DEFAULT 0,
// //         reg_last_serial_number INTEGER DEFAULT 0,
// //         leave_last_serial_number INTEGER DEFAULT 0,
// //         created_at TEXT,
// //         updated_at TEXT
// //       )
// //     ''');
...
//
// //   Future<void> _createDB(Database db, int version) async {
// //     // 1. organization_master (PDF Page 1 - Match exactly)
// //     await db.execute('''
// //       CREATE TABLE organization_master (
// //         org_name TEXT PRIMARY KEY,
// //         org_short_name TEXT UNIQUE,
// //         org_email TEXT UNIQUE,
// //         office_start_tax TEXT,
// //         parking_tax_b_number TEXT,
// //         parking_at TEXT,
// //         created_at TEXT,
// //         updated_at TEXT
// //       )
// //     ''');
//
// //     // 2. project_master (PDF Page 2 - Match exactly)
// //     await db.execute('''
// //       CREATE TABLE project_master (
// //         project_id TEXT PRIMARY KEY,
// //         org_short_name TEXT,
...
// //     ''');
//
// //     // 3. project_site_mapping (PDF Page 2 - Match exactly)
// //     await db.execute('''
// //       CREATE TABLE project_site_mapping (
// //         project_site_id TEXT PRIMARY KEY,
// //         project_id TEXT NOT NULL,
...
// //     ''');
//
// //     // 4. user (PDF Page 2 - Match exactly)
// //     await db.execute('''
// //       CREATE TABLE user (
// //         emp_id TEXT PRIMARY KEY,
// //         email_id TEXT UNIQUE NOT NULL,
...
// //     ''');
//
// //     // 5. employee_attendance (PDF Page 2 - Match exactly)
// //     await db.execute('''
// //       CREATE TABLE employee_attendance (
// //         att_id TEXT PRIMARY KEY,
// //         emp_id TEXT NOT NULL,
...
// //     ''');
//
// //     // 6. employee_regularization (PDF Page 3 - Match exactly)
// //     await db.execute('''
// //       CREATE TABLE employee_regularization (
// //         reg_id TEXT PRIMARY KEY,
// //         emp_id TEXT NOT NULL,
...
// //     ''');
//
// //     // 7. employee_leaves (PDF Page 3 - Match exactly)
// //     await db.execute('''
// //       CREATE TABLE employee_leaves (
// //         leave_id TEXT PRIMARY KEY,
// //         emp_id TEXT NOT NULL,
...
// //     ''');
//
// //     // 8. user_roles (PDF Page 3 - Match exactly)
// //     await db.execute('''
...
// //     ''');
//
// //     // 9. employee_mapped_projects (PDF Page 3-4 - Match exactly)
// //     await db.execute('''
// //       CREATE TABLE employee_mapped_projects (
// //         emp_id TEXT NOT NULL,
// //         project_id TEXT NOT NULL,
...
// //     ''');
//
// //     // 10. employee_shifts (PDF Page 4 - Match exactly)
// //     await db.execute('''
...
// //     ''');
//
// //     // 11. employee_roles_mapping (PDF Page 4 - Match exactly)
// //     await db.execute('''
...
// //     ''');
//
// //     // 12. shift_master (PDF Page 4 - Match exactly)
// //     await db.execute('''
...
// //     ''');
//
// //     // 13. running_serial_number (PDF Page 4 - Match exactly)
// //     await db.execute('''
// //       CREATE TABLE running_serial_number (
// //         org_id TEXT PRIMARY KEY,
// //         project_last_serial_number INTEGER DEFAULT 0,
...
// //     ''');
//
// //     // 14. current_user (for session management)
// //     await db.execute('''
// //       CREATE TABLE current_user (
// //         id INTEGER PRIMARY KEY,
// //         user_data TEXT,
...
// //       final Map<String, dynamic> data = jsonDecode(jsonString);
//
// //       // Insert data for each table (match your JSON keys)
// //       await _insertTableData(db, 'user', data['user'] ?? []);
// //       await _insertTableData(
// //         db,
// //         'organization_master',
...
// //         );
// //       } catch (e) {
// //         print("Error inserting into $tableName: $e - Data: $item");
// //       }
// //     }
// //   }
//
...
// //       'emp_id': 'NUTANTEKE20250601',
// //       'email_id': 'emp1@nutantek.com',
// //       'password': 'emp123',
// //       'emp_status': 'active',
...
// //     });
//
// //     await db.insert('running_serial_number', {
// //       'org_id': 'NUTANTEK',
// //       'project_last_serial_number': 1,
// //       'emp_last_serial_number': 1,
// //       'att_last_serial_number': 1,
// //       'reg_last_serial_number': 1,
// //       'leave_last_serial_number': 1,
// //       'created_at': DateTime.now().toIso8601String(),
// //       'updated_at': DateTime.now().toIso8601String(),
// //     });
// //   }
...
// //     if (user.isNotEmpty) {
// //       // Get role mapping
// //       final roleMapping = await db.query(
// //         'employee_roles_mapping',
// //         where: 'emp_id = ?',
// //         whereArgs: [empId],
// //       );
//
// //       // Get shift info
// //       final shiftInfo = await db.query(
// //         'employee_shifts',
// //         where: 'emp_id = ?',
// //         whereArgs: [empId],
// //       );
...
// //         userData['role_id'] = roleMapping.first['role_id'];
// //       }
// //       if (shiftInfo.isNotEmpty) {
// //         userData['shift_id'] = shiftInfo.first['shift_id'];
// //       }
// //       if (projects.isNotEmpty) {
// //         userData['projects'] = projects.map((p) => p['project_id']).toList();
// //       }
//
// //       return userData;
// //     }
...
// //   }
//
// //   // Get pending regularization requests for manager
// //   Future<List<Map<String, dynamic>>> getPendingRegularizations(
// //     String mgrEmpId,
// //   ) async {
// //     final db = await database;
// //     return await db.query(
...
// //       whereArgs: [mgrEmpId, 'pending'],
// //       orderBy: 'reg_date_applied DESC',
// //     );
// //   }
//
// //   // Get employee leaves
// //   Future<List<Map<String, dynamic>>> getEmployeeLeaves(String empId) async {
// //     final db = await database;
// //     return await db.query(
// //       'employee_leaves',
// //       where: 'emp_id = ?',
...
// //     ''');
//
// //     // 7. employee_regularization
// //     await db.execute('''
// //       CREATE TABLE employee_regularization (
// //         reg_id TEXT PRIMARY KEY,
// //         emp_id TEXT NOT NULL,
// //         reg_applied_for_date TEXT NOT NULL,
// //         reg_date_applied TEXT NOT NULL,
// //         reg_type TEXT NOT NULL, -- 'Full Day', 'Check-in Only', 'Check-out Only'
// //         reg_justification TEXT NOT NULL,
// //         checkin_time TEXT,
// //         checkout_time TEXT,
// //         shortfall_time TEXT,
// //         reg_approval_status TEXT DEFAULT 'pending',
...
// //         leave_type TEXT,
// //         leave_justification TEXT,
// //         leave_approval_status TEXT, -- Pending/Approved/Rejected
// //         manager_comments TEXT,
// //         created_at TEXT,
// //         updated_at TEXT
// //       )
...
// //     ''');
//
// //     // 10. employee_shifts_mapping (corrected typo from "shits")
// //     await db.execute('''
// //       CREATE TABLE employee_shifts_mapping (
// //         emp_id TEXT NOT NULL,
// //         shift_id TEXT NOT NULL
// //       )
// //     ''');
...
// //       final Map<String, dynamic> data = jsonDecode(jsonString);
//
// //       // Insert data for each table (null-safe)
// //       await _insertTableData(db, 'user', data['user'] ?? []);
// //       await _insertTableData(
// //         db,
// //         'organization_master',
...
// //   }
//
// //   // Helper: Get user by emp_id (full profile from employee_master + user)
// //   Future<Map<String, dynamic>?> getUserByEmpId(String empId) async {
// //     final db = await database;
// //     final user = await db.query(
// //       'user',
...
// //         final userData = {...user.first, ...empDetails.first};
// //         return userData;
// //       }
// //     }
// //     return null;
