...
// FINAL & ERROR-FREE VERSION - January 13, 2026
// All missing getters added: isPresent, formattedCheckIn, formattedCheckOut, etc.
// Null-safe, UI-ready, computed fields
// Fully compatible with dummy_data & DB structure
...
extension AttendanceModelExtension on AttendanceModel {
  ...
  IconData get statusIcon => switch (dailyStatus) {
    DailyAttendanceStatus.present => Icons.check_circle_rounded,
    DailyAttendanceStatus.absent => Icons.cancel_rounded,
    DailyAttendanceStatus.leave => Icons.beach_access,
    DailyAttendanceStatus.partialLeave => Icons.hourglass_bottom_rounded,
    DailyAttendanceStatus.shortHalf => Icons.timelapse_rounded,
    DailyAttendanceStatus.holiday => Icons.celebration_rounded,
    DailyAttendanceStatus.weekend => Icons.weekend_rounded,
...
AttendanceModel attendanceFromDB(Map<String, dynamic> row) {
  return AttendanceModel(
    ...
    checkInTime: _parseDateTime(row['first_checkin'] as String?),
    checkOutTime: _parseDateTime(row['last_checkout'] as String?),
    ...
    workedHours: row['worked_hrs'] as double?,
    photoProofPath: row['photo_proof_path'] as String?,
    dailyStatus: _mapDailyStatus(row['att_type'] as String? ?? 'present'),
