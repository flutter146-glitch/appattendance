...
// FORMAL, SIMPLIFIED & PROFESSIONAL VERSION (Animation Minimal)
// - All heavy animations removed (no Hero, no AnimatedSwitcher, no Fade/Scale)
// - Clean, minimal UI with high readability
// - Status filter widget integrated (All / Active / Inactive)
// - Search + filter combined (real-time)
// - Shimmer removed (simple progress + empty/error states)
// - Pull-to-refresh with haptic feedback
// - Dark/light mode contrast optimized
// - No unnecessary shadows/gradients
                          ...
                          child: Card(
                            ...
                            child: ListTile(
                              ...
                              leading: CircleAvatar(
                                radius: 28,
                                backgroundColor: member.statusColor.withOpacity(
                                  0.2,
                                ),
                                child: Text(
